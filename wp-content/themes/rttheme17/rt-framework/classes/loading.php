...
class RTTheme{
	...
	function rt_create_menus() {
		...
		register_nav_menu( 'rt-theme-product-navigation', __( 'RT Theme Product Sidebar Navigation' , 'rt_theme_admin' ));
	...
	function theme_supports(){
		//Featured Images
		add_theme_support( 'post-thumbnails', array('slider','home_page','page') );
