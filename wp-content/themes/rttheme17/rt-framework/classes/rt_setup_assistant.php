			 ...
			 #
				...
				echo '<div class="step_contents">';
					...
					foreach ($contents->step[$key]->contents as $contentID => $theContent) {
						if(!$contents->step[$key]->single_step) echo '<div class="step_content">'.($theContent->content_title).' <span class="step_number">Step '.$content_number.' </span>  </div>';			 
						echo (!$contents->step[$key]->single_step)  ? '<div class="step_content_hidden">' : '<div class="step_content_hidden show">';						
