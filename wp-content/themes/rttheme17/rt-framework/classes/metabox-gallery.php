					...
					if ( $output ) { ?>  
							...
							<div class="rt-gallery-uploaded-photos">
								...
								<div class="block-<?php echo $i;?>">								 
									...
									<tr> 									
										<td class="col1">
											<div class=""><img class="loadit" src="<?php echo $rt_gallery_images[$i];?>"  id="rt-gallery-image-<?php echo $i;?>-show">
											<img src="<?php echo THEMEADMINURI; ?>/images/delete.png" class="delete rt-gallery-image-<?php echo $i;?>" id="delete_rt-gallery-image-<?php echo $i;?>-show">
											</div>
										</td>										
									</tr>
									</table>
										...
										<tr>
											<td class="col1">
												<div class="form_element upload">
													<input type="text" name="<?php echo $this->prefix;?>rt_gallery_images[]" value="<?php echo $rt_gallery_images[$i];?>" id="rt-gallery-image-<?php echo $i;?>" class="upload_field">
												</div>
												<input type="button" value="Upload" class="rttheme_upload_button rt-gallery-image-<?php echo $i;?>  button"/>  
											</td>
										</tr>
				...
				<div class="rt_photo_holder block-<?php echo $newRTPhotoFormID;?>">
					...
					<table>
						<tr style="display:none;"> 									
							<td class="col1">
								<div class=""><img class="loadit" src="<?php echo THEMEADMINURI; ?>/images/blank.png" id="rt-gallery-image-<?php echo $newRTPhotoFormID;?>-show"></div>
								<img src="<?php echo THEMEADMINURI; ?>/images/delete.png" class="delete  rt-gallery-image-<?php echo $newRTPhotoFormID;?>" id="delete_rt-gallery-image-<?php echo $newRTPhotoFormID;?>-show"> 
							</td>										
						</tr>
					</table>
					...
					<table>
						...
						<tr>
							<td class="col1">
								<div class="form_element upload">
									<input type="text" name="<?php echo $this->prefix;?>rt_gallery_images[]" value="" id="rt-gallery-image-<?php echo $newRTPhotoFormID;?>" class="upload_field">
								</div>
								
								<input type="button" value="Upload" class="rttheme_upload_button rt-gallery-image-<?php echo $newRTPhotoFormID;?> button"/>  
							</td>
						</tr>
		...
		function saveCustomFields( $post_id ) {
			...
			if ( !wp_verify_nonce( @$_POST[ $this->settings['slug'].'_wpnonce' ], $this->settings['slug'] ) )
				...
				if ( current_user_can( $this->settings['capability'], $post_id ) ) {
					...
					$images 		= @$_POST[ $this->prefix."rt_gallery_images"];		 
					$image_titles 	= @$_POST[ $this->prefix."rt_gallery_image_titles"];		 
					$image_descs 	= @$_POST[ $this->prefix."rt_gallery_image_descs"];		 
