	...
	tinymce.create('tinymce.plugins.rt_theme_shortcodes', {
		init : function(ed, url) {
			...
			ed.addButton('rt_themeshortcode_11', {
					...
					onclick : function() {
						window.tinyMCE.execInstanceCommand(window.tinyMCE.activeEditor.editorId, 'mceInsertContent', false, '[accordion align="" numbers="false" first_one_open="false"]<br />[pane title="Accordion Pane 1"] content [/pane] <br />[pane title="Accordion Pane 2"] content [/pane] <br />[pane title="Accordion Pane 3"] content [/pane] <br />[/accordion]<br /><br /> ');
						window.tinyMCE.activeEditor.execCommand('mceRepaint');
