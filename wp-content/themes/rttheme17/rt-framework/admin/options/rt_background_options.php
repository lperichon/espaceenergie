...
$options = array (
	...
	"desc" 		=> __('Click right side of the box below to pick a color. If you would like to tunn back the default color, just delete the value and save options.','rt_theme_admin'),
