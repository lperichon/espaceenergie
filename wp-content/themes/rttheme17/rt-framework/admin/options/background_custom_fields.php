...
*/ 
	...
	$customFields = array(
				...
				"description" 		=> __('Click right side of the box below to pick a color. If you would like to tunn back the default color, just delete the value and update this post','rt_theme_admin'),
	...
	$settings  = array( 
		...
		"scope"		=> array('post','page','portfolio','products'),
